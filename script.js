...
const players = []; // Lista de empleados
const teams = []; // Lista de empresas

// Lista de posiciones en el fÃºtbol
const positions = [
    "Administrador de empresas", // PosiciÃ³n de portero
    "Diseñador Grafico", // PosiciÃ³n de defensa central
    "Ingeniero en Sistemas", // PosiciÃ³n de lateral derecho
    "Contador", // PosiciÃ³n de lateral izquierdo
    "Secretaria", // PosiciÃ³n de mediocampista defensivo
    "RRHH", // PosiciÃ³n de mediocampista defensivo
    "Lider de Producción", // PosiciÃ³n de mediocampista defensivo
    "Marketing", // PosiciÃ³n de mediocampista defensivo
];
...
function loadPositions() {
    ...
    positionSelect.innerHTML = `<option value="">Seleccione una ocupación</option>`; // Agrega la opciÃ³n predeterminada
